...
@section('content')
    <div class="container">
        <div class="card">
            ...
            <!-- Modal -->
            <div class="modal fade" id="updateprofile{{ $user->id }}" tabindex="-1"
                        ...
                        <div class="modal-body">
                            <form action="{{ route('profile.update', $user->id) }}" method="POST">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingInput" placeholder="nama" name="name" value="{{ old('name', $user->name) }}">
